export const bearsLoveMemesAbi = [
	{
		type: "constructor",
		inputs: [
	...
	{ type: "function", name: "mintWithETH", inputs: [], outputs: [], stateMutability: "payable" },
	{
		type: "function",
		name: "name",
		inputs: [],
	...
	{
		type: "event",
		name: "BearsLoveMemes_TokensBurned",
		inputs: [
	...
	{
		type: "event",
		name: "BearsLoveMemes_TokensMinted",
		inputs: [
			{ name: "account", type: "address", indexed: true, internalType: "address" },
			{ name: "amount", type: "uint256", indexed: false, internalType: "uint256" },
