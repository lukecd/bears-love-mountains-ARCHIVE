export const bearsLoveMountainsAbi = [
	{
		type: "constructor",
		inputs: [
			{ name: "_name", type: "string", internalType: "string" },
			{ name: "_symbol", type: "string", internalType: "string" },
			{ name: "_salesTaxThreshold", type: "uint256", internalType: "uint256" },
			{ name: "_defiContract", type: "address", internalType: "address" },
		],
	...
	},
	{
		...
		name: "defiContract",
		inputs: [],
		outputs: [{ name: "", type: "address", internalType: "contract BearsLoveDefi" }],
		stateMutability: "view",
	},
	{
		type: "function",
	...
	{
		type: "event",
		name: "BearsLoveMountains_TaxTransferred",
		inputs: [{ name: "amount", type: "uint256", indexed: false, internalType: "uint256" }],
		anonymous: false,
	},
	{
		type: "event",
		name: "BearsLoveMountains_TokensBurned",
		inputs: [
			{ name: "account", type: "address", indexed: true, internalType: "address" },
			{ name: "tokenId", type: "uint256", indexed: true, internalType: "uint256" },
			{ name: "amount", type: "uint256", indexed: false, internalType: "uint256" },
			{ name: "refundAmount", type: "uint256", indexed: false, internalType: "uint256" },
			{ name: "taxAmount", type: "uint256", indexed: false, internalType: "uint256" },
		],
		anonymous: false,
	},
	{
		type: "event",
		name: "BearsLoveMountains_TokensMinted",
		inputs: [
			{ name: "account", type: "address", indexed: true, internalType: "address" },
			{ name: "tokenId", type: "uint256", indexed: true, internalType: "uint256" },
			{ name: "amount", type: "uint256", indexed: false, internalType: "uint256" },
	...
	{ type: "error", name: "TokenIdExceedsMaximum", inputs: [] },
] as const;
