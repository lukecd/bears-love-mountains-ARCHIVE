...
const Footer: React.FC = () => {
	return (
		<div className="bg-footerBg text-footerText w-full mt-15 z-20">
			<div className="container flex flex-col md:w-2/5 lg:flex-row  items-center">
				...
				<div className="w-full lg:w-1/3 mt-4 lg:mt-0 flex flex-col items-start text-sm text-bg">
